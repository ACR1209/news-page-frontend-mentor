  ...
  return (
    <div className='flex h-100 lg:mb-0 mb-10 flex-col w-100 flex-grow lg:w-fit'>
        ...
        <div className='w-100 block lg:flex mt-8 lg:space-x-5 '>
            <h1 className='text-[3.5rem] leading-[3.5rem] font-extrabold flex-1'>{article.title}</h1>
            <div className='w-100 ml-0 px-0 lg:px-8 flex-1 flex flex-col text-left justify-between'>
                ...
                <button className='bg-softRed mt-10 hover:bg-darkBlue font-bold text-offWhite tracking-[0.2rem] py-3 px-10 w-fit'>READ MORE</button>
            </div>
        </div>
    </div>
  )
